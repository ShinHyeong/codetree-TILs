...
# ex. 정렬 전(indexed_sequence) : [(1,8), (2,3), (3,5)] / 인덱스:pos(위치별) , 내용:value
# -> 정렬 후(indexed_sequence) : [(2,3), (3,5), (1,8)] / 인덱스:rank(등수별), 내용:value
# 위치별 등수 저장하는 리스트(ranks) : [3, 1, 2] / 인덱스: pos, 내용:rank
